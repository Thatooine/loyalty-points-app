...
type MockAccountService struct {
	...
	FetchMyAccountsFunc      func(t *testing.T, m *MockAccountService, ctx context.Context, request pkgAccounts.FetchMyAccountsRequest) (*pkgAccounts.FetchMyAccountsResponse, error)
...
func (m *MockAccountService) FetchMyAccounts(ctx context.Context, request pkgAccounts.FetchMyAccountsRequest) (*pkgAccounts.FetchMyAccountsResponse, error) {
	if m.FetchMyAccountsFunc == nil {
		return nil, nil
	}
	return m.FetchMyAccountsFunc(m.T, m, ctx, request)
}
